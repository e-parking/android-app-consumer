...
public class ParkPlaceList {
    ...
    public ParkPlaceList() {
    }


    public ParkPlaceList(String mProviderID, String mParkPlaceID, String mParkPlaceTitle, String mParkingType, String mParkingStatus, String mParkedVehicle, String mParkingChargePerHour) {
